...
injection_parameters = dict(
    mass_1=1.5, mass_2=1.3, chi_1=0.02, chi_2=0.02, luminosity_distance=10179.,
    theta_jn=0.04, psi=2.659, phase=1.3, geocent_time=1735257618, 
    ra=49.6, dec=-46.4, lambda_1=300, lambda_2=350)
...
priors = bilby.gw.prior.BNSPriorDict()
for key in ['geocent_time']:
    priors[key] = injection_parameters[key]
priors.pop('mass_ratio')
priors.pop('lambda_1')
priors.pop('lambda_2')
priors['chirp_mass'] = bilby.core.prior.Gaussian(
    1.7, 0.1, name='chirp_mass', unit='$M_{\\odot}$')
priors['symmetric_mass_ratio'] = bilby.core.prior.Uniform(
    0.1, 0.25, name='symmetric_mass_ratio')
# priors['lambda_1'] = bilby.core.prior.Uniform(minimum=0, maximum=5000, name='lambda_1', latex_label='$\\Lambda_1$', unit=None)
# priors['lambda_2'] = bilby.core.prior.Uniform(minimum=0, maximum=5000, name='lambda_2', latex_label='$\\Lambda_2$', unit=None)
priors['lambda_tilde'] = bilby.core.prior.Uniform(0, 1000, name='lambda_tilde')
...
result = bilby.run_sampler(
    likelihood=likelihood, priors=priors, sampler='nestle', npoints=10,
