...
Use "all" to get all possible combinations of the detectors given.''')
    ...
    # fisher_parameters = ['ra', 'dec', 'psi', 'theta_jn', 'luminosity_distance', 'mass_1', 'mass_2', 'geocent_time', 'phase', 'lambda_1', 'lambda_2']
    ...
    gw.detection.analyzeDetections(network, parameters, population, networks_ids, name)

    if calculate_errors:
        gw.fishermatrix.analyzeFisherErrors(network, parameters, fisher_parameters, population, networks_ids, name)
